...
let url = 'http://localhost:8021/cf/alarm-weather/export-excel';
...
axios.get(url, {params: queryParams, paramsSerializer,responseType: 'blob'}).then(response => {
  console.log(response);
  // const excelData=response.data;
  // fs.writeFile('example.xlsx', excelData, (err) => {
  //   if (err) throw err;
